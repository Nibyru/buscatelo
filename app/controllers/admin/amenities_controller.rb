class Admin::AmenitiesController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @amenity.update(amenity_params)
        format.html { redirect_to admin_amenity_path(@amenity), notice: 'Amenity was successfully updated.' }
  ...
  def destroy
    @amenity.destroy
    respond_to do |format|
      format.html { redirect_to admin_amenities_url, notice: 'Amenity was successfully destroyed.' }
  ...
  private
    ...
    def amenity_params
      params.require(:amenity).permit(:name, :place_id, :icon)
    end
end
